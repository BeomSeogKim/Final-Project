package Backend.FinalProject.api.controller.member;

import Backend.FinalProject.api.controller.member.request.*;
import Backend.FinalProject.api.service.member.MemberService;
...
public class MemberController {
    ...
    /**
     * 회원가입
     * @param signupRequest 회원 가입에 필요한 데이터
     */
    @PostMapping("/member/signup")
    public ResponseDto<Object> signUp(
            @ModelAttribute @Valid SignupRequestDto signupRequest) {
